MODULE ran_state
!This module supports the random number routines ran0 , ran1 , ran2 , and ran3 . It pro-
...
Simply return if enough space is already al-
hgt=hg
located.
...
if (lenran > 0 ) then 
	...
	nullify(ranseed,ranv,iran,jra,kran,mran,nran)
	lenran = 0
end if
...
random seed routine, with one additional argument keyword: sequence , set to any inte-
...
The various constants are chosen to give
ir=ieor(ir,ishft(ir,-16))+1842055030
good bit mixing and should not be

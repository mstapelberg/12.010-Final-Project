...
!3) to do an additional itmx iterations
...
!Compute final results for this iteration.
		...
		do j=1,ndim
!Refine the grid. Consult references to under-
!stand the subtlety of this procedure. The
!refinement is damped, to avoid rapid,
!destabilizing changes, and also compressed
!in range by the exponent ALPH.
			xo=d(1,j)
			xn=d(2,j)
			d(1,j)=(xo+xn)/2.0_sp
